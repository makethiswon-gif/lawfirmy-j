      ...
      <section className={styles.profSection}>
        <div className="container">
          ...
          <div className={styles.profGrid}>
            {[
              { name: '양영희', title: '대표변호사', img: '/images/profiles/양영희 변호사_unified.jpg', spec: '기업법무 · 민사 · 가사', id: 'young-hee-yang' },
              { name: '장병우', title: '대표변호사', img: '/images/profiles/장병우 변호사_unified.jpg', spec: '건설·부동산 · 민사 · 행정', id: 'byung-woo-jang' },
              { name: '김정웅', title: '대표변호사', img: '/images/profiles/김정웅 변호사_unified.jpg', spec: '민사 · 형사 · 기업법무', id: 'jung-woong-kim' },
            ].map((lawyer, idx) => (
